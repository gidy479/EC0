                ...
                <div className="grid gap-6">
                    {sales.map(order => (
                        <div key={order._id} className="glass p-6 rounded-3xl shadow-sm flex flex-col md:flex-row gap-8 relative overflow-hidden group border border-white/40">
                            ...
                            <div className="w-24 h-24 flex-shrink-0 bg-white rounded-2xl overflow-hidden self-center md:self-start border border-gray-100 shadow-inner">
                            ...
                            <div className="flex-grow space-y-4 relative z-10">
                                <div className="flex flex-col md:flex-row justify-between gap-4">
                                    <div>
                                        <h3 className="text-lg font-black text-gray-800 leading-tight">{order.product?.name || 'Deleted Product'}</h3>
