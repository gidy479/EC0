                ...
                <form onSubmit={submitHandler} className="relative z-10 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                        ...
                        <div>
                            ...
                            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Leave blank to keep current" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-400 focus:border-green-400 outline-none transition-all font-bold text-gray-800 placeholder-gray-300" />
                        </div>
